...
from ModelMsc import Model_msc
...
def configure():
    ...
    flags.DEFINE_string('pretrain_file', './models/deeplab_resnet.ckpt',
    ...
    # data
    flags.DEFINE_string('data_dir', '/home/z840/ALISURE/Data/VOC2012', 'data directory')
    ...
    # log
    flags.DEFINE_string('modeldir', 'models', 'model directory')
